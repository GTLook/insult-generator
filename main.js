...
function adv() {
  return adverbes[Math.floor(Math.random() * adverbes.length)]
}

function hand() {
  return handActions[Math.floor(Math.random() * handActions.length)]
}
...
function animal() {
  return mammals[Math.floor(Math.random() * mammals.length)]
}
...
function outrage() {
  return outrageText[Math.floor(Math.random() * outrageText.length)]
}
